...
func getLogo(osName string) Logo {
	...
	case strings.Contains(name, "endeavour"):
		l = []string{
			"       /\\     ",
			"    / /  \\\\   ",
			"   / /    \\ \\ ",
	...
	case strings.Contains(name, "mint"):
		l = []string{
			" ___________ ",
			"|_          \\",
			"  | | _____ |",
	...
	case strings.Contains(name, "manjaro"):
		l = []string{
			"||||||||| ||||",
			"||||||||| ||||",
			"||||      ||||",
	...
	case strings.Contains(name, "pop!"):
		l = []string{
			"______           ",
			"\\   _ \\       __ ",
			" \\ \\ \\ \\     / / ",
	...
	case strings.Contains(name, "ultramarine"):
		l = []string{
			" .@@@@@@@@@@@@@. ",
			".@@@@@@@@@@@@@@@.",
			"@@@@@@@@@@@@@@@@@",
